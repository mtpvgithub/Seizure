...
public static String Id_proof_result="";
	...
	public class Async_getIDS extends AsyncTask<Void, Void, String>
	{
		...
		protected String doInBackground(Void... params) {
			...
			if ("NA".equals(Id_proof_result) ||"anyType{}".equals(Id_proof_result) || Id_proof_result == null) {
				Id_proof_result = null ;
			} else {
				//resp_array = new String[0];
				Id_proof_result = result.toString();
				PreviousHistory.resp_array = Id_proof_result.split("@");
				Log.i("enter in to do in background id detils size::::::::::", ""+PreviousHistory.resp_array.length);
			}
		...
		protected void onPostExecute(String result) {
			...
			if (PreviousHistory.Id_proof_result.trim()!=null) {
				
				Log.i("enter in to post execute id detils size::::::::::", ""+PreviousHistory.resp_array.length);
	...
	public class Asyncprevoius_history_ID extends AsyncTask<Void, Void, String>
	{
		...
		protected void onPostExecute(String result) {
			...
			Log.i("previous histroy based on ID ::::::::::", ""+response_id);
